...
La realización de esta parte consistió en calcular la autocorrelación para el nuevo proceso aleatorio al considerar tanto a <img src="http://www.sciweavers.org/tex2img.php?eq=%20%5COmega%20&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt=" \Omega " width="17" height="15" /> como a <img src="http://www.sciweavers.org/tex2img.php?eq=%20%20%5CTheta%20&bc=White&fc=Black&im=jpg&fs=12&ff=arev&edit=0" align="center" border="0" alt="  \Theta " width="17" height="15" /> como constantes. Al hacer esto, hay que realizar el mismo procedimiento que se le hizo al proceso de la parte A pero esta vez para la nueva expresión de X(t) dada. 
